...
namespace pstore {
  namespace http {
    ...
    public:
      ...
      http_state set_state_to_shutdown () noexcept { return state_.exchange (http_state::closing); }
      ...
      bool listening (http_state expected) noexcept {
        return state_.compare_exchange_strong (expected, server_status::http_state::listening);
      }
