//===- include/pstore/exchange/import_fixups.hpp ----------*- mode: C++ -*-===//
//*  _                            _      __ _                       *
...
namespace pstore {
  namespace exchange::import_ns {
    ...
    public:
      ...
      fixups_object (not_null<context *> const ctxt, not_null<string_mapping const *> const names,
