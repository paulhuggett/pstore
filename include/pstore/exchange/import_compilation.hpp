...
namespace pstore::exchange::import_ns {
  ...
  public:
    ...
    definition (not_null<context *> ctxt, not_null<container *> definitions,
                not_null<string_mapping const *> names, fragment_index_pointer const & fragments);
  ...
  public:
    definition_object (not_null<context *> ctxt, not_null<definition::container *> definitions,
  ...
  public:
    compilations_index (not_null<context *> ctxt, not_null<transaction_base *> transaction,
                        not_null<string_mapping const *> names);
