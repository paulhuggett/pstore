...
namespace pstore {
  namespace repo {
    ...
    public:
      ...
      debug_line_section (index::digest const & header_digest,
    ...
    static_assert (alignof (debug_line_section) == 16, "debug_line_section alignment must be 16");
    ...
    public:
      ...
      debug_line_section_creation_dispatcher (debug_line_section_creation_dispatcher const &) =
        delete;
