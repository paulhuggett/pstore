...
namespace pstore {
  namespace repo {
    ...
    namespace details {
      ...
      template <typename CastToType, typename BaseIterator>
      constexpr auto cast_iterator<CastToType, BaseIterator>::operator* () const -> reference {
    ...
    public:
      ...
      template <typename IndexIterator,
                typename = typename std::enable_if_t<is_section_kind_iterator<IndexIterator> ()>>
      ...
      public:
        using iterator =
          details::cast_iterator<section_kind, typename array_type::indices::const_iterator>;
        ...
        section_kind front () const noexcept { return static_cast<section_kind> (i_.front ()); }
        section_kind back () const noexcept { return static_cast<section_kind> (i_.back ()); }
    ...
    constexpr section_sparray<T>::section_sparray (IndexIterator first, IndexIterator last)
      ...
      static_assert (std::numeric_limits<typename array_type::bitmap_type>::radix == 2,
