//===- include/pstore/command_line/word_wrapper.hpp -------*- mode: C++ -*-===//
//*                        _                                             *
...
namespace pstore {
  namespace command_line {
    ...
    public:
      ...
      explicit word_wrapper (std::string const & text, std::size_t const max_width = default_width)
              : word_wrapper (text, max_width, 0U) {}
      static word_wrapper end (std::string const & text, std::size_t max_width = default_width);
