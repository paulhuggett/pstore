//===- include/pstore/support/pointee_adaptor.hpp ---------*- mode: C++ -*-===//
//*              _       _                        _             _              *
...
namespace pstore {
  ...
  template <typename Iterator>
  inline pointee_adaptor<Iterator> operator+ (typename pointee_adaptor<Iterator>::difference_type n,
                                              pointee_adaptor<Iterator> a) {
    return a += n;
  }
