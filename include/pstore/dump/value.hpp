//===- include/pstore/dump/value.hpp ----------------------*- mode: C++ -*-===//
//*             _             *
//* __   ____ _| |_   _  ___  *
//* \ \ / / _` | | | | |/ _ \ *
//*  \ V / (_| | | |_| |  __/ *
...
namespace pstore {
  namespace dump {
    ...
    public:
      indent () = default;
      indent next (unsigned const distance) const noexcept { return indent{count_ + distance}; }
    ...
    public:
      ...
      virtual number_long const * dynamic_cast_number_long () const noexcept { return nullptr; }
      virtual number_ulong * dynamic_cast_number_ulong () noexcept { return nullptr; }
      virtual number_ulong const * dynamic_cast_number_ulong () const noexcept { return nullptr; }
      virtual number_double * dynamic_cast_number_double () noexcept { return nullptr; }
      virtual number_double const * dynamic_cast_number_double () const noexcept { return nullptr; }
      ...
      virtual std::wostream & write_impl (std::wostream & os, indent const & indent) const = 0;
    };
    ...
    public:
      ...
      number_double const * dynamic_cast_number_double () const noexcept override { return this; }
    ...
    public:
      ...
      number_ulong const * dynamic_cast_number_ulong () const noexcept override { return this; }
    ...
    inline value_ptr make_value (array::container && members) {
      return std::static_pointer_cast<value, array> (std::make_shared<array> (std::move (members)));
    }
