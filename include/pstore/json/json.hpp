  ...
  namespace json {
    ...
    namespace details {
      ...
      private:
        ...
        consume_normal_state (parser<Callbacks> & parser, char32_t code_point, appender & app);
      ...
      root_matcher<Callbacks>::consume (parser<Callbacks> & parser, maybe<char> ch) {
        ...
        case new_token_state: {
          ...
          case '8':
          case '9':
            return {this->template make_terminal_matcher<number_matcher<Callbacks>> (parser),
                    false};
          case '"':
          ...
          case 't':
            return {
              ...
              false};
          case 'f':
            return {this->template make_terminal_matcher<false_token_matcher<Callbacks>> (parser,
                                                                                          "false"),
                    false};
          case 'n':
            return {
    ...
    parser<Callbacks>::parser (Callbacks callbacks, extensions const extensions)
      ...
      stack_.push (mpointer (
        new (&singletons_->trailing_ws) details::whitespace_matcher<Callbacks>{}, deleter{false}));
