...
TEST (UUID, GoodHex) {
  ...
  pstore::uuid const expected{
    pstore::uuid::container_type{{0x00, 0x99, 0xAA, 0xFF, 0xAA, 0xFF, 0x09, 0x90, 0x00, 0x99, 0xAA,
...
TEST (UUID, MixedCase) {
  EXPECT_EQ (
    pstore::uuid ("aaaaaaaa-AAAA-aAAa-FFff-fFFf00000000"),
    pstore::uuid (pstore::uuid::container_type{{0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
