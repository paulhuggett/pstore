...
namespace {
  ...
  bool case_insensitive_equal (std::string::const_iterator const lhs_first,
    ...
    return std::equal (lhs_first, lhs_last, rhs_first, [] (char const a, char const b) noexcept {
  ...
  bool case_insensitive_equal (std::string const & lhs, std::string::const_iterator const rhs_first,
                               std::string::const_iterator const rhs_last) noexcept {
