...
namespace pstore {
  ...
  void logger::log (priority const p, gsl::czstring const message, unsigned long long const d) {
    this->log (p, to_string (message, d));
  }
...
namespace {
  ...
  void asl_logger::log (priority const p, gsl::czstring const message, unsigned long long const d) {
    // NOLINTNEXTLINE
